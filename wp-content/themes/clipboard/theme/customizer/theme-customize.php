...
if ( !function_exists( 'vk_register' ) ) {
    ...
    function vk_register ( $wp_customize ) {
        ...
        $vk['add_div'][] = array( 20, 'divider3','Divider');
            ...
            $vk['add_sec'][] = array( 99, 'tools','UI Tools');
        
        $vk['add_div'][] = array( 99, 'divider4','Divider');
...
';
        ...
        $vk['add_set'][] = array($p.'logo_type','logoText');
        $vk['add_con'][] = array( 2, $p.'logo_type','Logo Type','logo','select', $choices_lp );


                // font
                $vk['add_set'][] = array($p.'logo_font','Raleway');
        ...
        $vk['add_set'][] = array($p.'logo_position','logoHeader');
        $vk['add_con'][] = array( 14, $p.'logo_position','Logo Position','logo','select', $choices_lp );
                ...
                $vk['add_set'][] = array($p.'logo_alignment','logoLeft');
        ...
        $vk['add_con'][] = array( 2, $p.'tagline','Include Tagline Below Logo','tagline','checkbox');
                ...
                // font
                $vk['add_set'][] = array($p.'tagline_font','helvetica');
        ...
        $vk['add_set'][] = array($p.'menu_position', 'menuHeader');
        $vk['add_con'][] = array( 1, $p.'menu_position','Main Menu Position','mainmenu','select', $choices_mp);
                ...
                $vk['add_set'][] = array($p.'sidebar_menu_style', 'sideStyleStandard', 'on');
        ...
        $vk['add_set'][] = array($p.'sidebar_function', 'leftSidebarSlide');
        ...
        $vk['add_set'][] = array($p.'sidebar_shadow', 'sideShad5');
        ...
        $vk['add_set'][] = array($p.'content_alignment', 'conCenter');
        ...
        $vk['add_set'][] = array($p.'content_shadow', 'conShad1');
        ...
        // Blog Template
        $vk['add_set'][] = array($p.'blog_template','msnryFixedfull','on');
        $vk['add_con'][] = array( 1, $p.'blog_template','Blog Template','layout','select', $choices_srt );

        // Search Template
        $vk['add_set'][] = array($p.'search_template','msnryFixedfull','on');
        ...
        $vk['add_set'][] = array($p.'pagination','seamlessInfinite','on');
        ...
        // content
        $vk['add_set'][] = array($p.'landing_page', '0', 'on');
        ...
        $vk['add_set'][] = array($p.'landing_alignment','landingLeft');
        ...
        // h1 font family
        $vk['add_set'][] = array($p.'type_h1_font','Raleway','on');
        ...
        // h2 font family
        $vk['add_set'][] = array($p.'type_h2_font','Raleway','on');
        ...
        // h3 font family
        $vk['add_set'][] = array($p.'type_h3_font','Raleway','on');
        ...
        // h4 font family
        $vk['add_set'][] = array($p.'type_h4_font','Raleway','on');
        ...
        // h5 font family
        $vk['add_set'][] = array($p.'type_h5_font','Raleway','on');
        ...
        // h6 font family
        $vk['add_set'][] = array($p.'type_h6_font','Raleway','on');
        ...
        // p font family
        $vk['add_set'][] = array($p.'type_p_font','helvetica','on');
        ...
        // Button Font 
        $vk['add_set'][] = array($p.'button_font', 'helvetica');
        ...
        $vk['add_set'][] = array($p.'blog_content_trim', 'blog-readmore', 'on');
        $vk['add_con'][] = array( 1, $p.'blog_content_trim','Content Trim Style','general_settings','select',$choices_blog_trim);
            ...
            $vk['add_set'][] = array($p.'blog_read_more', 'more-text', 'on');
        ...
        // create a variable with all the options for later use
        ...
        foreach ($vk['add_set'] as $setting) {
            ...
            // force an option update if the option doesn't exist
            // this is required as of WP 4.1
            if( !array_key_exists($setting[0], $all_options) ) {

                update_option($setting[0],$setting[1]);
