...
/*-----------------------------------------------------------------------------------*/
	...
	// deactivate the theme on switch or update
	if ( ! function_exists('vk_deactive_theme') ) {
		function vk_deactive_theme(){

			update_option('vk_theme_activate','');

		}
		add_action('after_switch_theme','vk_deactive_theme');
	}
	...
	function vk_message_activation() { ?>
			...
			<div id="vk_landing">
				...
				<div id="vk_landing_inner">
					...
					<h3><strong>Theme Activation Required.</strong></h3>

					<p>Before you can start using <strong><?php echo wp_get_theme(); ?></strong>, please tick <strong>Activate Theme</strong> in the <a href="<?php echo admin_url(); ?>customize.php">Theme Customizer</a>.
						Then click save and refresh this page. This is a requirement for newly installed or updated themes.</p>

					<img src="<?php echo get_template_directory_uri(); ?>/framework/images/vkmessage-activate.png">
