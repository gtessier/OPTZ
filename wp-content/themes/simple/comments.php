...
<?php if ( comments_open() ) :// Comment Form ?>
	...
	<div id="respond">
		<div class="wt_title wt_heading_3"><h3><span><?php comment_form_title( esc_html__('Leave a Reply', 'wt_front'), esc_html__('Leave a Reply to %s', 'wt_front') ); ?></span></h3></div>
...
<?php else : ?>
    ...
    <?php else : ?>	
                <div class="commentform row-fluid">
                   <input type="text" name="author" class="required col-lg-4 col-md-4" id="author" value="<?php echo esc_attr($comment_author ); ?>" size="22" tabindex="1" data-minlength="3" placeholder="Name" />
                    <input type="text" name="email" class="required email col-lg-4 col-md-4" id="email" value="<?php echo esc_attr( $comment_author_email ); ?>" size="22" tabindex="2" placeholder="E-mail" />
                    <input type="text" name="url" class="url col-lg-4 col-md-4" id="url" value="<?php echo esc_attr( $comment_author_url ); ?>" size="22" tabindex="3" placeholder="Website" />
                </div>
    <?php endif; ?>
			...
			<p>                                
			    <a id="submit" href="#" onclick="jQuery('#commentform').submit();return false;" class="btn btn-primary dark"><span><?php esc_html_e('Post Comment', 'wt_front');?></span></a><?php comment_id_fields(); ?>  
