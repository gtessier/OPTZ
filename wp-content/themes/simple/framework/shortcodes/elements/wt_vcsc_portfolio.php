...
class WPBakeryShortCode_WT_portfolio extends WPBakeryShortCode {
	...
	protected function content($atts, $content = null) {
		...
		if ($carousel == "true") {
			...
			$output .= '<div id="wt_owl_carousel_'.$id.'" class="wt_owl_carousel" data-owl-speed="600" data-owl-pagSpeed="1000" data-owl-autoPlay="'.$auto_slide.'" data-owl-stopOnHover="true" data-owl-navigation="'.$carousel_nav.'" data-owl-pagination="'.$carousel_pag.'" data-owl-items="'.$columns.'" data-owl-itemsDesktop="'.$columns.'"  data-owl-itemsSmallDesktop="'.$columns.'" data-owl-itemsSmallDesktop="'.$columns.'" data-owl-itemsTablet="3" data-owl-itemsMobile="1" data-owl-itemsMobileSmall="1">';
		}
...
if (function_exists('wpb_map')) {
	...
	wpb_map( array(
		...
		'params' => array(
			...
			array(
				'type'               => 'dropdown',
				'heading'            => esc_html__('Carousel Pagination', 'wt_vcsc'),
				...
				'description'   => esc_html__('Enables carousel pagination.', 'wt_vcsc')
			),
			array(
				'type'          => 'dropdown',
