...
function wt_enqueue_scripts() {
	...
	wp_register_script( 'jquery-fss', THEME_JS .'/vendor/fss.js', array('jquery'), null, true);
	wp_register_script( 'jquery-fss-settings', THEME_JS .'/vendor/fss-settings.js', array('jquery'), null, true);
...
function wt_enqueue_styles(){
	...
	wp_enqueue_style('theme-fantastic', THEME_CSS.'/fonts.css', array(), null, 'all');
