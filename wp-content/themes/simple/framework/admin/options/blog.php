...
$wt_options = array(
	...
	array(
		...
		array(
			...
			array(
				"name" => esc_html__("<em>\"Full Layout\"</em> - Featured Image Height",'wt_admin'),
			...
			array(
				"name" => esc_html__("<em>\"Full Layout\"</em> - Featured Slide Height",'wt_admin'),
			...
			array(
				"name" => esc_html__("<em>\"Sidebar Layout\"</em> - Featured Image Height",'wt_admin'),
			...
			array(
				"name" => esc_html__("<em>\"Sidebar Layout\"</em> - Featured Slide Height",'wt_admin'),
