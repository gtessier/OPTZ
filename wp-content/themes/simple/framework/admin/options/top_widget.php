...
$wt_options = array(
	array(
		"name" => esc_html__("Top Widget",'wt_admin'),
		"type" => "wt_title"
	),
	array(
		"name" => esc_html__("Top Widget",'wt_admin'),
		...
		array(
			"name" => esc_html__("Top Widget",'wt_admin'),
			"desc" => esc_html__("If the button is set to OFF then the top widget area won't be displayed.",'wt_admin'),
			"id" => "top_widget",
			"default" => false,
			"type" => "wt_toggle"
		),
		array(
			"name" => esc_html__("Top Widget Column Layout",'wt_admin'),
			"desc" => esc_html__("Choose the top widget column layout.",'wt_admin'),
			"id" => "widget_column",
