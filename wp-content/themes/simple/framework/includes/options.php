...
class wt_options {
	...
	*/
	...
	function wt_flex_custom_slider($get_options) {
		...
		<input name="flex_custom_slider_count" id="flex_custom_slider_count" class="slider_counter count_hide_rm" type="hidden" value="<?php echo esc_attr( $get_options['flex_custom_slider_count'] ); ?>" />
		...
		?>	
			...
			<td>                   
                <div class="formField">
                    <p class="description"><?php echo esc_attr( $desc ); ?></p>
                    <input class="correct_num upload-value" id="flex_custom_slider_url_<?php echo (int)$z; ?>" name="flex_custom_slider_url_<?php echo (int)$z; ?>" type="text" value="<?php if (!empty($get_options['flex_custom_slider_url_'.$z])) { echo wt_check_input($get_options['flex_custom_slider_url_'.$z]);	} ?>" size="50" />  
                    <?php
					global $wp_version;
					if(version_compare($wp_version, "3.5", '<')){ ?>
						<div class="theme-upload-buttons"><a class="upload_number thickbox button button-primary theme-upload-button" id="flex_custom_slider_url_<?php echo (int)$z . '_button' ; ?>" href="media-upload.php?&target=flex_custom_slider_url_<?php echo (int)$z;?>&option_image_upload=1&type=image&TB_iframe=1&width=640&height=529"><?php echo esc_attr( $button ); ?></a>
                        <a class="upload_number button-secondary theme-upload-media-button theme-upload-remove" id="flex_custom_slider_url_<?php echo (int)$z . '_remove' ; ?>"><?php echo esc_attr( $removebutton ); ?></a>
                    </div>
					<?php } else { ?>
                    <div class="theme-upload-buttons"><a href="#" class="upload_number button theme-upload-button button-primary" id="flex_custom_slider_url_<?php echo (int)$z . '_button' ; ?>" data-target="flex_custom_slider_url_<?php echo (int)$z;?>" data-uploader_title="<?php echo esc_attr( $button ); ?>" data-uploader_button_text="<?php echo esc_attr( $button ); ?>"><?php echo esc_attr( $button ); ?></a>
					<a class="upload_number button-secondary theme-upload-media-button theme-upload-remove" id="flex_custom_slider_url_<?php echo (int)$z . '_remove' ; ?>"><?php echo esc_attr( $removebutton); ?></a>
                    </div>
					<?php } ?>
                ...
                <div class="formField">
                    ...
                    <input class="correct_num" id="flex_custom_slider_link_<?php echo (int)$z; ?>" name="flex_custom_slider_link_<?php echo (int)$z; ?>" type="text" value="<?php if (!empty($get_options['flex_custom_slider_link_'.$z])) {  echo wt_check_input($get_options['flex_custom_slider_link_'.$z]); } ?>" size="50"/>
                </div>
                
                <div class="formField">
                    <p class="description">Slider Caption</p>
                    <textarea class="correct_num" id="flex_custom_slider_caption_<?php echo (int)$z; ?>" name="flex_custom_slider_caption_<?php echo (int)$z; ?>" rows="5"><?php if (!empty($get_options['flex_custom_slider_caption_'.$z])) { echo stripslashes($get_options['flex_custom_slider_caption_'.$z]); } ?></textarea>
                    <p class="description">Flex Caption Position</p>
                    <select class="correct_num" id="flex_custom_slider_caption_position_<?php echo (int)$z; ?>" name="flex_custom_slider_caption_position_<?php echo (int)$z; ?>">
			...
			<td>
                <div id="flex_custom_slider_url_<?php echo (int)$z ?>_preview" class="theme-option-image-preview">       
                <?php
...
<?php				
	...
	*/
	...
	function wt_nivo_custom_slider($get_options) {
		...
		<input name="nivo_custom_slider_count" id="nivo_custom_slider_count" class="slider_counter count_hide_rm" type="hidden" value="<?php echo esc_attr($get_options['nivo_custom_slider_count'] ); ?>" />
		...
		?>	
			...
			<td>                   
                <div class="formField">
                    <p class="description"><?php echo esc_attr( $desc ); ?></p>
                    <input class="correct_num upload-value" id="nivo_custom_slider_url_<?php echo (int)$z; ?>" name="nivo_custom_slider_url_<?php echo (int)$z; ?>" type="text" value="<?php if (!empty($get_options['nivo_custom_slider_url_'.$z])) { echo wt_check_input($get_options['nivo_custom_slider_url_'.$z]); } ?>" size="50" />                
                     <?php
					global $wp_version;
					if(version_compare($wp_version, "3.5", '<')){ ?>
						<div class="theme-upload-buttons"><a class="upload_number thickbox button button-primary theme-upload-button" id="<?php echo (int)$get_options['id'] . '_button' . $z ; ?>" href="media-upload.php?&target=nivo_custom_slider_url_<?php echo (int)$z;?>&option_image_upload=1&type=image&TB_iframe=1&width=640&height=529"><?php echo (int)$button; ?></a>
                    <a class="upload_number button-secondary theme-upload-media-button theme-upload-remove" id="nivo_custom_slider_url_<?php echo (int)$z . '_remove' ; ?>"><?php echo esc_attr( $removebutton ); ?></a>
                    </div>
					<?php } else { ?>
                  
                    <div class="theme-upload-buttons"><a href="#" class="upload_number button theme-upload-button button-primary" id="nivo_custom_slider_url_<?php echo (int)$z . '_button' ; ?>" data-target="nivo_custom_slider_url_<?php echo (int)$z;?>" data-value="nivo_custom_slider_url_<?php echo (int)$z;?>" data-uploader_title="<?php echo esc_attr( $button ); ?>" data-uploader_button_text="<?php echo esc_attr( $button); ?>"><?php echo esc_attr( $button ); ?></a>
                    <a class="upload_number button-secondary theme-upload-media-button theme-upload-remove" id="nivo_custom_slider_url_<?php echo (int)$z . '_remove' ; ?>"><?php echo esc_attr( $removebutton ); ?></a>
                    </div>
                ...
                <div class="formField">
                    <p class="description">Slider Url</p>
                    <input class="correct_num" id="nivo_custom_slider_link_<?php echo (int)$z; ?>" name="nivo_custom_slider_link_<?php echo (int)$z; ?>" type="text" value="<?php if (!empty($get_options['nivo_custom_slider_link_'.$z])) { echo wt_check_input($get_options['nivo_custom_slider_link_'.$z]); } ?>" size="50"/>
                </div>
                
                <div class="formField">
                    <p class="description">Slider Caption</p>
                    <textarea class="correct_num" id="custom_slider_caption_<?php echo (int)$z; ?>" name="custom_slider_caption_<?php echo (int)$z; ?>"  rows="5"><?php if (!empty($get_options['custom_slider_caption_'.$z])) { echo stripslashes($get_options['custom_slider_caption_'.$z]); } ?></textarea>
                </div>
			</td>
			<td>
                <div id="nivo_custom_slider_url_<?php echo (int)$z ?>_preview" class="theme-option-image-preview">       
                <?php
...
<?php				
	...
	*/
	...
	function wt_cycle_custom_slider($get_options) {
		...
		<input name="cycle_custom_slider_count" id="cycle_custom_slider_count" class="slider_counter count_hide_rm" type="hidden" value="<?php echo esc_attr( $get_options['cycle_custom_slider_count'] ); ?>" />
		...
		?>	
			...
			<td>                    
                <div class="formField">
                    <p class="description"><?php echo esc_attr( $desc ); ?></p>
                    <input class="correct_num upload-value" id="cycle_custom_slider_url_<?php echo (int)$z; ?>" name="cycle_custom_slider_url_<?php echo (int)$z; ?>" type="text" value="<?php if (!empty($get_options['cycle_custom_slider_url_'.$z])) { echo wt_check_input($get_options['cycle_custom_slider_url_'.$z]); } ?>" size="50" />                
                    <?php
					global $wp_version;
					if(version_compare($wp_version, "3.5", '<')){ ?>
						<div class="theme-upload-buttons"><a class="upload_number thickbox button button-primary theme-upload-button" id="cycle_custom_slider_url_<?php echo (int)$z . '_button' ; ?>" href="media-upload.php?&target=cycle_custom_slider_url_<?php echo (int)$z;?>&option_image_upload=1&type=image&TB_iframe=1&width=640&height=529"><?php echo esc_attr( $button ); ?></a>
                   
                    <a class="upload_number button-secondary theme-upload-media-button theme-upload-remove" id="cycle_custom_slider_url_<?php echo (int)$z . '_remove' ; ?>"><?php echo esc_attr( $removebutton ); ?></a>
                </div>
					<?php } else { ?>
                  
                    <div class="theme-upload-buttons"><a href="#" class="upload_number button theme-upload-button button-primary" id="cycle_custom_slider_url_<?php echo (int)$z . '_button' ; ?>" data-target="cycle_custom_slider_url_<?php echo (int)$z;?>" data-uploader_title="<?php echo esc_attr( $button ); ?>" data-uploader_button_text="<?php echo esc_attr( $button ); ?>"><?php echo esc_attr( $button ); ?></a>
                ...
                <div class="formField">
                    ...
                    <input class="correct_num" id="cycle_custom_slider_link_<?php echo (int)$z; ?>" name="cycle_custom_slider_link_<?php echo (int)$z; ?>" type="text" value="<?php if (!empty($get_options['cycle_custom_slider_url_'.$z])) { echo wt_check_input($get_options['cycle_custom_slider_link_'.$z]); } ?>" size="50"/>
                </div> 
                ...
                <div class="formField">
                    ...
                    <select class="correct_num" id="custom_slider_cycle_type_<?php echo (int)$z; ?>" name="custom_slider_cycle_type_<?php echo (int)$z; ?>" >
                        <option id="custom_slider_cycle_image_<?php echo (int)$z; ?>" value="image" <?php if (isset($get_options['custom_slider_cycle_type_'.$z]) && $get_options['custom_slider_cycle_type_'.$z] == "image") echo "selected='selected'"; ?>>Slide item with image</option>
                        <option id="custom_slider_cycle_html_<?php echo (int)$z; ?>" value="html" <?php if (isset($get_options['custom_slider_cycle_type_'.$z]) && $get_options['custom_slider_cycle_type_'.$z] == "html") echo "selected='selected'"; ?>>Slide item html</option>
                        <option id="custom_slider_cycle_youtube_<?php echo (int)$z; ?>" value="youtube" <?php if (isset($get_options['custom_slider_cycle_type_'.$z]) && $get_options['custom_slider_cycle_type_'.$z] == "youtube") echo "selected='selected'"; ?>>Slide YouTube</option>
                    </select> 
			        <span class="wt_option_selected"><?php echo esc_attr( $selected_opt ); ?></span> 
                    </span>                                                          
                </div> 
                
                <div class="formField cycle_options custom_slider_cycle_image_caption_<?php echo (int)$z; ?>">
                    <p class="description">Cycle Slider Caption</p>
                    <textarea class="correct_num" id="custom_slider_cycle_image_caption_<?php echo (int)$z; ?>" name="custom_slider_cycle_image_caption_<?php echo (int)$z; ?>" rows="5"><?php if (!empty($get_options['cycle_custom_slider_url_'.$z])) { echo stripslashes($get_options['custom_slider_cycle_image_caption_'.$z]); } ?></textarea>
                </div>  
                                  
                <div class="formField cycle_options custom_slider_cycle_html_text_<?php echo (int)$z; ?>">
                    <p class="description">Cycle Slider HTML</p>
                    <textarea class="correct_num" id="custom_slider_cycle_html_text_<?php echo (int)$z; ?>" name="custom_slider_cycle_html_text_<?php echo (int)$z; ?>" rows="5"><?php if (!empty($get_options['cycle_custom_slider_url_'.$z])) { echo stripslashes($get_options['custom_slider_cycle_html_text_'.$z]); } ?></textarea>
                </div> 
                                        
                <div class="formField cycle_options custom_slider_cycle_color_<?php echo (int)$z; ?> padTop10">
                    ...
                    <div class="color-input-wrap">
                        <input id="custom_slider_cycle_color_<?php echo (int)$z; ?>" name="custom_slider_cycle_color_<?php echo (int)$z; ?>" class="correct_num colorinput" type="text" value="<?php if (!empty($get_options['custom_slider_cycle_color_'.$z])) { echo wt_check_input($get_options['custom_slider_cycle_color_'.$z]);} ?>" data-hex="true">
                    </div>                        
                </div>                         
                ...
                <script>
                    jQuery(document).ready(function () {
                        ...
                        var $slider_type = jQuery("#custom_slider_cycle_type_<?php echo (int)$z; ?>").val(); 
                        var $slider_caption = jQuery(".custom_slider_cycle_image_caption_<?php echo (int)$z; ?>");
                        var $slider_html = jQuery(".custom_slider_cycle_html_text_<?php echo (int)$z; ?>");
                        var $slider_html_color = jQuery(".custom_slider_cycle_color_<?php echo (int)$z; ?>");
                        ...
                        jQuery("#custom_slider_cycle_type_<?php echo (int)$z; ?>").change(function () {
			...
			<td>  
                <div id="cycle_custom_slider_url_<?php echo (int)$z ?>_preview" class="theme-option-image-preview">       
                <?php
